...
export const FactualityDecisionSchema = z.object({
    factual: z.boolean().describe("Whether the blog is intended to be factual (true) or non-factual (false)"),
});
...
export const FactSchema = z.object({
    claims: z.array(
        z.object({
            ...
            is_verifiable: z.boolean().describe("Whether this claim can be verified using external sources."),
        })
    ),
});
