 ...
 */
export const researchSummaryPrompt = (topic: string, searchResults: string): string =>
 ...
 */
export const draftBlogPrompt = (topic: string, summary: string): string =>
 ...
 */
export const refineBlogPrompt = (draft: string): string =>
 ...
 */
export const seoPrompt = (topic: string, refinedDraft: string): string =>
 ...
 */
export const formatMdxPrompt = (seoOptimized: { title: string; meta: string; content: string }): string =>
